...
//  MemoApp_SierraWise
//
//  Created by Wise, Sierra R. on 8/29/24.
//
...
class MemoListTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        notificationCenter.requestAuthorization(options: [.alert, .badge, .sound, .criticalAlert], completionHandler: {(didAllow, Error) in
            if didAllow{
